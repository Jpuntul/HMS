  ...
  useEffect(() => {
    const fetchPerson = async () => {
      ...
      try {
        ...
        setErrors({ general: "Failed to load person data." });
      } finally {
    ...
    return (
      <div className="min-h-screen bg-paper py-8">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          <div className="badge-card flex items-center justify-center p-8">
            <div
              className="h-8 w-8 animate-spin rounded-full border-2 border-paper-line border-t-ink"
              role="status"
    ...
    <div className="min-h-screen bg-paper py-8">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        <div className="badge-card p-8">
          <h1 className="mb-6 text-2xl font-bold text-ink">Edit Person</h1>
